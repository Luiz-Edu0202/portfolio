...
// Projetos 
const projectsData = [
    { name: "KOLEKTO", icon: "fas fa-store", desc_en: "E-commerce for collectibles, deployed with CI/CD and unit tests.", desc_pt: "E-commerce para colecionáveis, publicado com CI/CD e testes.", tech: ["Python", "Django", "Azure", "SQLite", "Bootstrap"], links: [{ text_en: "GitHub", text_pt: "GitHub", url: "#" }, { text_en: "Live Demo", text_pt: "Demo", url: "#" }] },
    { name: "SUB!", icon: "fas fa-closed-captioning", desc_en: "Tool to facilitate collaborative subtitling for Libreflix platform.", desc_pt: "Ferramenta para facilitar legendagem colaborativa na plataforma Libreflix.", tech: ["Java", "Maven", "Eclipse"], links: [{ text_en: "GitHub", text_pt: "GitHub", url: "#" }] },
    { name: "PRIS.ME", icon: "fas fa-hand-holding-heart", desc_en: "Management platform for NGOs (real client: Caçadores de Bons Exemplos).", desc_pt: "Plataforma de gestão para ONGs (cliente real: Caçadores de Bons Exemplos).", tech: ["Python", "Django", "Azure", "Jira", "Bootstrap"], links: [{ text_en: "GitHub", text_pt: "GitHub", url: "#" }, { text_en: "Website", text_pt: "Site", url: "#" }] },
    { name: "Line Following Robot", icon: "fas fa-robot", desc_en: "Open-source robot with PID control system. Reached Top 10 at RoboCore Experience.", desc_pt: "Robô seguidor de linha open-source com controle PID. Top 10 na RoboCore Experience.", tech: ["ESP32", "C/C++", "PID Control", "Hardware"], links: [{ text_en: "GitHub", text_pt: "GitHub", url: "#" }] },
    { name: "Coffee Break", icon: "fas fa-mug-hot", desc_en: "Arduino-based scale to monitor coffee level in thermos.", desc_pt: "Balança com Arduino para monitorar nível de café em garrafa térmica.", tech: ["Arduino", "C++", "Hardware"], links: [{ text_en: "Tutorial", text_pt: "Tutorial", url: "#" }] }
];
